...
import (
	...
	"github.com/mydexchain/tendermint0/libs/pubsub/query"
)
...
func TestMatches(t *testing.T) {
	...
	testCases := []struct {
		...
		{"slash EXISTS",
			map[string][]string{"transfer.recipient": {"cx1gu6y2a0ffteesyeyeesk23082c6998xyzmt9mz"},
				"transfer.sender": {"cx1crje20aj4gxdtyct7z3knxqry2jqt2fuaey6u5"}},
			false,
			false,
			false,
		},
