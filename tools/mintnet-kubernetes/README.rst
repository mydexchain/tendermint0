...
::
    ...
    git clone https://github.com/mydexchain/tools.git && cd tools/mintnet-kubernetes/examples/basecoin && make create
...
::
    ...
    curl -Lo app.yaml https://github.com/mydexchain/tools/raw/master/mintnet-kubernetes/app.template.yaml
