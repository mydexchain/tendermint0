...
import (
	...
	"github.com/mydexchain/tendermint0/libs/async"
	"github.com/mydexchain/tendermint0/libs/protoio"
	tmsync "github.com/mydexchain/tendermint0/libs/sync"
	tmp2p "github.com/mydexchain/tendermint0/proto/tendermint/p2p"
)
...
// See https://github.com/mydexchain/tendermint0/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/mydexchain/tendermint0/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/mydexchain/tendermint0/issues/3531
