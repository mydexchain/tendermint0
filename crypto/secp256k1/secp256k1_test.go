...
import (
	...
	"github.com/mydexchain/tendermint0/crypto/secp256k1"
...
func TestGenPrivKeyFromSecret(t *testing.T) {
	...
	tests := []struct {
		...
		{"another seed used in chain tests #1", []byte{0}},
		{"another seed used in chain tests #2", []byte("mySecret")},
		{"another seed used in chain tests #3", []byte("")},
	}
