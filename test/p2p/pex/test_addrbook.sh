...
docker cp "local_testnet_$ID:/go/src/github.com/mydexchain/tendermint0/test/p2p/data/mach0/config/addrbook.json" "/tmp/addrbook.json"
set +e #CIRCLE
...
docker cp "/tmp/addrbook.json" "local_testnet_$ID:/go/src/github.com/mydexchain/tendermint0/test/p2p/data/mach0/config/addrbook.json"
echo "with the following addrbook:"
cat /tmp/addrbook.json
# exec doesn't work on circle
# docker exec "local_testnet_$ID" cat "/go/src/github.com/mydexchain/tendermint0/test/p2p/data/mach0/config/addrbook.json"
echo ""
