...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/mydexchain/tendermint0' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/tendermint
    ln -s /vagrant /home/vagrant/go/src/github.com/mydexchain/tendermint0
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/mydexchain/tendermint0 && make tools'
  SHELL
end
