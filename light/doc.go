...
https://github.com/mydexchain/spec/blob/master/spec/consensus/light-client/verification.md
for details.
...
for usage example.
Or see
https://github.com/mydexchain/spec/tree/master/spec/consensus/light-client
for the full spec
*/
package light
